...
def prompt_step2(step1_list):
    return (
        "You are generating realistic postpartum diary entries.\n"
        "For each item, write a **first-person diary** between **160–260 words**.\n"
        "\n"
        "CRITICAL REQUIREMENTS:\n"
        "• Use the woman's perspective.\n"
        "• Include emotional nuance, subtle stressors, and daily details.\n"
        "• Reflect the EPDS risk classification accurately:\n"
        "     - low risk → calm, stable, mild worries\n"
        "     - watchful waiting → periodic stress, mild sadness\n"
        "     - mild PPD → noticeable anxiety & guilt, functioning but struggling\n"
        "     - moderate PPD → intrusive thoughts, overwhelm, emotional fatigue\n"
        "     - severe PPD → intense distress, hopelessness, difficulty bonding\n"
        "• Do NOT make it overly dramatic.\n"
        "• Keep language natural and varied.\n"
        "• Use different narrative styles.\n"
        "\n"
        "For each input, output ONLY a JSON LIST of objects with:\n"
        "  • synthetic_text\n"
        "  • target (copy of estimated_risk)\n"
        "  • style: always set to 'first-person postpartum diary'\n\n"
