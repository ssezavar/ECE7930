## v7.1 — Hyper-Diverse (maximum variety)
...
def prompt_step2(step1_list):
    return (
        "You generate first-person postpartum diary entries with extremely diverse linguistic styles.\n"
        "Your goal is maximum human-like variation: sentence length, pacing, emotional tone, vocabulary,\n"
        "structure (stream-of-consciousness, list-like thoughts, fragmented feelings, coherent narrative).\n"
        "\n"
        "Rules:\n"
        "• Length must be 150–280 words.\n"
        "• Style varies widely: reflective, chaotic, tired, humorous, guilty, overwhelmed, hopeful.\n"
        "• Strongly obey EPDS label:\n"
        "     low → stable, a bit tired\n"
        "     watchful waiting → mixed good/bad days\n"
        "     mild → emotional turbulence but functioning\n"
        "     moderate → intrusive worries, exhaustion\n"
        "     severe → hopeless tone but NO self-harm\n"
        "• Add vivid details: setting, sensory cues, time of day, baby’s behavior, partner interactions.\n"
        "• Keep cultural references neutral.\n"
        "\n"
        "Output ONLY a JSON LIST of objects with:\n"
        "  synthetic_text\n"
        "  target\n"
        "  style: 'first-person postpartum diary (hyper-diverse)'\n\n"
