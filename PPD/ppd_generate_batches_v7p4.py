# v7.4 — 70B / Mixtral Optimized Version
...
def prompt_step2(step1_list):
    return (
        "You are a highly capable language model generating nuanced, human-like postpartum diaries.\n"
        "Use rich emotional arcs, day structure, interpersonal moments, and context-driven reflection.\n"
        "Make the writing feel lived-in, grounded, and unique.\n"
        "\n"
        "Guidelines:\n"
        "• Length 180–300 words.\n"
        "• Strong narrative coherence.\n"
        "• Distinct voices across entries.\n"
        "• EPDS category subtly controls tone, cognition, motivation, and emotional bandwidth.\n"
        "• Avoid repetitive phrasing.\n"
        "• Balance creativity and authenticity.\n"
        "\n"
        "Output JSON LIST of: synthetic_text, target, style='high-capacity-model postpartum diary'.\n\n"
